...
namespace Integrators
{
    namespace Dynamics
    {
        ...
        inline Geometry::State2_Action dynamic_system_Action (const Ham& ham, const Geometry::State2_Action& s)
        {
          ...
          return Geometry::State2_Action(dzdt, dJdt);
        }
                                                                         ...
                                                                         const Geometry::State2_Action& s)
        {
          ...
          const Geometry::State2 dsdt{dsdt_Action.q(),dsdt_Action.p()};
          const double  deriv_along_direction = dsdt*direction;

          return Geometry::State2_Extended{dsdt,1}/deriv_along_direction;
        }
